...
for ii=1:numel(TRKS_IN)
    ...
    if strcmp(flag_project,'AD23NC23')
        ...
        spec_field.voltrx_FX_DOT_L(ii,1)=TRKS_IN{ii}.header.data.voltrx_FX_DOT_L_mm3;
        spec_field.voltrx_FX_DOT_R(ii,1)=TRKS_IN{ii}.header.data.voltrx_FX_DOT_R_mm3;
        spec_field.voltrx_FX_DOT_bil(ii,1)=TRKS_IN{ii}.header.data.voltrx_FX_DOT_BIL_mm3;
    end
    %number of strlines
